...
/***/ function(module, exports, __webpack_require__) {
	...
	var Drag = function (_Component) {
	  ...
	  _createClass(Drag, [{
	    ...
	    value: function render(props, state) {
	      return (0, _preact.h)(
	        'div',
	        { draggable: 'true', onDrag: function onDrag() {
	            console.log(1);
	          }, OnDragDrop: function OnDragDrop() {
	            console.log(1);
	          }, style: this.style, onMouseDown: this.dargStart, onMouseUp: this.dargStop },
	        props.children
	      );
	    }
	  }]);
	...
	var DragGroup = function (_Component2) {
	  ...
	  _createClass(DragGroup, [{
	    key: 'dargSort',
	    value: function dargSort(index, dx, dy) {
	    ...
	    value: function render(props, state) {
	      ...
	      var group = this.state.list.map(function (text, i) {
	        return (0, _preact.h)(
	          Drag,
	          { index: i, onSort: _this3.dargSort },
	          (0, _preact.h)('img', { src: text, width: '100', height: '100' })
	        );
	      });
	      return (0, _preact.h)(
	        'div',
...
/***/ function(module, exports) {
	...
	var sidebar = ["./images/83.jpg", "./images/50b58PICzJM_1024.jpg", "./images/tooopen_sy_123059936785.jpg"];
